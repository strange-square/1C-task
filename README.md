...
## Алгоритм решения
Проект реализован на языке Go с использованием стандартных библиотек для чтения файлов и сравнения их содержимого. Для каждой пары файлов вычисляется процент сходства, сравнивая количество совпадающих байтов с общим количеством байтов в наибольшем файле.
